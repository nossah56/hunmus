...
GAME_MESSAGE = "⩹━𒍮⊷━⌞ 𓏺َِ𝑺𝑶𝑼𝑹𝑪𝑬 𝑯𝑼𝑵𝑻𝑬𝑹 𖤐⌝━⊶𒍮━⩺\n\n𒍮¦ مرحبا بك عزيزي:\n𒍮¦في قسم العاب هانتر\n\n⩹━𒍮⊷━⌞ 𓏺َِ𝑺𝑶𝑼𝑹𝑪𝑬 𝑯𝑼𝑵𝑻𝑬𝑹 𖤐⌝━⊶𒍮━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('𒍮¦العاب 3D', callback_data= 'GAME1'),
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━𒍮⊷━⌞ 𓏺َِ𝑺𝑶𝑼𝑹𝑪𝑬 𝑯𝑼𝑵𝑻𝑬𝑹 𖤐⌝━⊶𒍮━⩺\n\nمرحبا بك في قسم العاب هانتر 3D\n\n⩹━𒍮⊷━⌞ 𓏺َِ𝑺𝑶𝑼𝑹𝑪𝑬 𝑯𝑼𝑵𝑻𝑬𝑹 𖤐⌝━⊶𒍮━⩺"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━𒍮⊷━⌞ 𓏺َِ𝑺𝑶𝑼𝑹𝑪𝑬 𝑯𝑼𝑵𝑻𝑬𝑹 𖤐⌝━⊶𒍮━⩺\n\n𒍮¦مرحبا بك في قسم العاب هانتر\n𒍮¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━𒍮⊷━⌞ 𓏺َِ𝑺𝑶𝑼𝑹𝑪𝑬 𝑯𝑼𝑵𝑻𝑬𝑹 𖤐⌝━⊶𒍮━⩺" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('𒍮¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('𒍮¦العاب هانتر', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞ 𓏺َِ𝑺𝑶𝑼𝑹𝑪𝑬 𝑯𝑼𝑵𝑻𝑬𝑹 𖤐⌝⚡️', url =f"https://t.me/huntersource")              
                 ],[
                InlineKeyboardButton(
               ...
               SOURCE_GAME = "⩹━𒍮⊷━⌞ 𓏺َِ𝑺𝑶𝑼𝑹𝑪𝑬 𝑯𝑼𝑵𝑻𝑬𝑹 𖤐⌝━⊶𒍮━⩺\n\n𒍮¦العاب هانتر7\n𒍮¦كت\n𒍮¦تويت\n𒍮¦اسال\n𒍮¦اصراحه\n\n⩹━𒍮⊷━⌞ 𓏺َِ𝑺𝑶𝑼𝑹𝑪𝑬 𝑯𝑼𝑵𝑻𝑬𝑹 𖤐⌝━⊶𒍮━⩺." 
